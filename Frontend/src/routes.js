...
const routes = [
  ...
  { path: '/admin/companies/edit/:id', exact: true, name: 'Update Companies', component : Company, props:{mode : "edit"}},
  { path: '/admin/companies/read/:id', exact: true, name: 'Info Companies', component : Company, props:{mode : "read"}},
