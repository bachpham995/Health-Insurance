    ...
    public class HealthInsuranceWebServerContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Employee>().HasData(
               ...
               , new Employee(){ EmployeeId = 2, FName = "Bach", LName="Pham Xuan", Username="bachpham", Password="123", Email ="kitnapper009@gmail.com",Designation = "Senior SE", Phone = "012345678X", Role = 1
