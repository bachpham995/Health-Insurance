    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Senior Cleaner", new DateTime(1996, 5, 30, 0, 0, 0, 0, DateTimeKind.Unspecified), "phatltuit@gmail.com", "Phat", new DateTime(2031, 1, 4, 14, 29, 44, 784, DateTimeKind.Local).AddTicks(5217), "Luu Trong", "123", "058256332X", false, false, "phatltuit" },
                    { 2, "Junior Cleaner", new DateTime(1996, 5, 30, 0, 0, 0, 0, DateTimeKind.Unspecified), "bachpham@gmail.com", "Bach", new DateTime(2031, 1, 4, 14, 29, 44, 787, DateTimeKind.Local).AddTicks(4091), "Pham Xuan", "123456789", "012345678X", false, false, "bachpham" },
                    { 3, "Junior Cleaner", new DateTime(1996, 5, 30, 0, 0, 0, 0, DateTimeKind.Unspecified), "nguyenvuhoanghoa@gmail.com", "Hoa", new DateTime(2031, 1, 4, 14, 29, 44, 787, DateTimeKind.Local).AddTicks(4138), "Nguyen Vu Hoang", "123456789", "01232278X", false, false, "nguyenvuhoanghoa" }
                });
